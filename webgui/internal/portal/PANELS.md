...
EPIRB RX and Radiosonde RX publish `geotable`, which mounts this renderer as its
upper half.
...
For apps whose entries *are* positions — AIS, APRS, EPIRB RX, Radiosonde RX: the
map above the table it came from, in one panel.
